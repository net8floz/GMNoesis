...
static void OnSlicesChanged(DependencyObject* d, const DependencyPropertyChangedEventArgs&)
{
    ...
    image->SetValue<float>(NineSliceImage::ThicknessLeft, slices.left);
    image->SetValue<float>(NineSliceImage::ThicknessBottom, slices.bottom);
    image->SetValue<float>(NineSliceImage::ThicknessRight, slices.right);
    image->SetValue<float>(NineSliceImage::ThicknessTop, slices.top);
...
NS_IMPLEMENT_REFLECTION(NineSliceImage, "NoesisGUIExtensions.NineSliceImage")
{
    ...
    data->RegisterProperty<float>(ThicknessBottom, "ThicknessBottom",
    PropertyMetadata::Create(1.f));

    
    data->RegisterProperty<float>(ThicknessLeft, "ThicknessLeft",
    PropertyMetadata::Create(1.f));

    
    data->RegisterProperty<float>(ThicknessRight, "ThicknessRight",
    PropertyMetadata::Create(1.f));

    
    data->RegisterProperty<float>(ThicknessTop, "ThicknessTop",
    PropertyMetadata::Create(1.f));
...
const DependencyProperty* NineSliceImage::ThicknessLeft;
const DependencyProperty* NineSliceImage::ThicknessRight;
const DependencyProperty* NineSliceImage::ThicknessTop;
const DependencyProperty* NineSliceImage::ThicknessBottom;