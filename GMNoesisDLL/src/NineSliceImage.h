...
namespace NineSlice
{
    ...
    public:
        ...
        static const Noesis::DependencyProperty* ThicknessLeft;
        static const Noesis::DependencyProperty* ThicknessRight;
        static const Noesis::DependencyProperty* ThicknessBottom;
        static const Noesis::DependencyProperty* ThicknessTop;
