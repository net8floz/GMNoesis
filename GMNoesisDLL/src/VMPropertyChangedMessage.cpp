...
char* VMPropertyChangedMessage::out_buffer_current = nullptr;
char* VMPropertyChangedMessage::out_buffer_start = nullptr;
size_t VMPropertyChangedMessage::buffer_size = 0;

void VMPropertyChangedMessage::reset_write_buffer()
{
...
void VMPropertyChangedMessage::prepare_write_buffer_for_reading()
{
...
void VMPropertyChangedMessage::write_to_buffer(const VMPropertyChangedMessage& msg)
{
    if (out_buffer_current == nullptr)
    {
        out_buffer_current = out_buffer_start;
